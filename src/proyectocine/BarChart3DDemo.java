...
public class BarChart3DDemo extends JFrame{
  ...
  JButton jbVolver;
      ...
      public BarChart3DDemo(ProyectoCine obj) {
       ...
       public void crearGrafico() {
        ...
        dataset.setValue(pc.contadorpelicula0, "Pelicula", "Pelicula0");
        dataset.setValue(pc.contadorpelicula1, "Pelicula", "Pelicula1");
        dataset.setValue(pc.contadorpelicula2, "Pelicula", "Pelicula2");
        dataset.setValue(pc.contadorpelicula3, "Pelicula", "Pelicula3");
     

        chart = ChartFactory.createBarChart3D(
                "Gráfica de Ventas Peliculas", //Nombre de la grafica
                "Peliculas Vendidas", //Nombre del eje Horizontal
                "Cantidad de boletos vendidos", //Nombre del eje vertical
                dataset, //Data
