 ...
 * @author jerso
 */
public class BarChart3DDemo3 extends JFrame{
  ...
  JButton jbVolver;
      ...
      public BarChart3DDemo3(ProyectoCine obj) {
       ...
       public void crearGrafico() {
        ...
        dataset.setValue(pc.contadoradmin, "Tipo Usuario", "Administrador");
        dataset.setValue(pc.contadorvendedor, "Tipo Usuario", "Vendedor");
         dataset.setValue(pc.contadorcliente, "Tipo Usuario", "Cliente");
    
     

        chart = ChartFactory.createBarChart3D(
                "Gráfica de Tipo de usuarios", //Nombre de la grafica
                "Tipo de usuarios", //Nombre del eje Horizontal
                "Cantidad de usuarios", //Nombre del eje vertical
                dataset, //Data
