 ...
 * @author jerso
 */
public class ConsultarProductosCli extends JFrame{
    ...
    public ConsultarProductosCli(ProyectoCine obj){
     ...
     public void crearGUI() {
        ...
        VentanaCliente nw = new VentanaCliente(va); // mostrar la ventana del menu principal
    }
